...
<body>
		...
		<div class="container">
				<div class="row">
						<div class="span2 bs-docs-sidebar catalog-tree" style="min-height: 350px;">
								<ul class="nav nav-list affix-top">
										<jsp:include page="/sys/catalog_list.jsp"></jsp:include>
								</ul>
						</div>

						<div class="span10 article-list">该栏目下的文章列表</div>
				</div>
		</div>
